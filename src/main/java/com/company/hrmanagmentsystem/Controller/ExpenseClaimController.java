...
public class ExpenseClaimController {
    ...
    @PutMapping("/paginationFilter")
    public ResponseEntity<?> paginationFilter(@RequestBody Map<String, Object> pageable) {

        List<ExpenseClaimDTO> dtos = service.paginationWithFilter(pageable);
        return new ResponseEntity<>(dtos, HttpStatus.OK);
    }

    @PutMapping("/paginationWithoutFilter")
    public ResponseEntity<?> paginationWithoutFilter(@RequestBody Map<String, Object> pageable) {

        List<ExpenseClaimDTO> dtos = service.paginationWithOutFilter(pageable);
        return new ResponseEntity<>(dtos, HttpStatus.OK);
    }
